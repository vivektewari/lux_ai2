...
from from_isaiah.utility_constants import MAX_CAPACITY, MAX_RESEARCH, MAX_BOARD_SIZE
from from_isaiah.lux.constants import Constants
...
def _transfer_factory(action_meaning: str) -> Callable[..., str]:
    ...
    def _transfer_func(unit: Unit, pos_to_unit_dict: Dict[Tuple, Optional[Unit]]) -> str:
        ...
        return unit.transfer(dest_id=dest_unit, resourceType=resource, amount=MAX_CAPACITY)
